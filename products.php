...
<div class="sidebar">
    ...
    <a href="#"><i class="fas fa-money-bill"></i> Báo cáo doanh thu</a>
            ...
            <tbody>
                <?php while ($row = $result_san_pham->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-sm"><i class="fas fa-edit"></i> Sửa</a>
                            <a href="delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?');"><i class="fas fa-trash"></i> Xóa</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
